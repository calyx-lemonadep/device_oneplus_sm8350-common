...
PRODUCT_COPY_FILES += \
    ...
    vendor/calyx/config/permissions/vendor.calyx.biometrics.fingerprint.inscreen.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor.calyx.biometrics.fingerprint.inscreen.xml
